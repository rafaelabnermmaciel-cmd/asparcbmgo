...
// além do tamanho da própria paleta. Compartilhada entre os gráficos do app pra manter
// consistência visual (mesma cor = mesma posição em qualquer gráfico de ranking).
